...
import com.tinychating.common.common.handler.GlobalUncaughtExceptionHandler;
...
public class WeChatMsgOperationServiceImpl implements WeChatMsgOperationService {
    ...
    private void publishTemplateMsgCheckLimit(WxMpTemplateMessage msgTemplate) {
        try {
            ...
            FrequencyControlUtil.executeWithFrequencyControl(FrequencyControlStrategyFactory.TOTAL_COUNT_WITH_IN_FIX_TIME_FREQUENCY_CONTROLLER, frequencyControlDTO,
