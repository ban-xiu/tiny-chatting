package com.tinychating.common.chatai.handler;
...
import com.tinychating.common.chatai.domain.builder.ChatGPTContextBuilder;
import com.tinychating.common.chatai.domain.builder.ChatGPTMsgBuilder;
import com.tinychating.common.chatai.properties.ChatGPTProperties;
import com.tinychating.common.chatai.utils.ChatGPTUtils;
import com.tinychating.common.common.constant.RedisKey;
import com.tinychating.common.common.domain.dto.FrequencyControlDTO;
import com.tinychating.common.common.exception.FrequencyControlException;
import com.tinychating.common.common.service.frequencycontrol.FrequencyControlUtil;
import com.tinychating.common.common.utils.DateUtils;
import com.tinychating.common.common.utils.RedisUtils;
import com.tinychating.common.user.domain.vo.response.user.UserInfoResp;
import com.tinychating.common.common.service.frequencycontrol.FrequencyControlStrategyFactory;
...
public class GPTChatAIHandler extends AbstractChatAIHandler {
    ...
    protected String doChat(Message message) {
        ...
        try {
            ...
            return FrequencyControlUtil.executeWithFrequencyControl(FrequencyControlStrategyFactory.TOTAL_COUNT_WITH_IN_FIX_TIME_FREQUENCY_CONTROLLER,
    ...
    private ChatGPTContext buildContext(Message message) {
        ...
        ChatGPTContext chatGPTContext = RedisUtils.get(RedisKey.getKey(RedisKey.USER_CHAT_CONTEXT, uid, roomId), ChatGPTContext.class);
    ...
    private void saveContext(ChatGPTContext chatGPTContext) {
        RedisUtils.set(RedisKey.getKey(RedisKey.USER_CHAT_CONTEXT, chatGPTContext.getUid(), chatGPTContext.getRoomId()), chatGPTContext, 5L, TimeUnit.MINUTES);
    }
